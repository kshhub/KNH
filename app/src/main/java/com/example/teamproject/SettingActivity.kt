...
class SettingActivity : AppCompatActivity() {
    ...
    val settingFragText = arrayListOf<String>("Customizing","User Info")
    val settingFragIcon = arrayListOf<Int>(R.drawable.ic_baseline_brush_24, R.drawable.ic_baseline_people_24)
